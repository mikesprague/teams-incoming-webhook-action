...
void (() => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (isDeployCard) {
            ...
            const { populateCard } = yield Promise.resolve().then(() => __importStar(__nccwpck_require__(6897)));
            messageToPost = populateCard({
                title,
                text: message,
                color: colorString,
    ...
    attachments: [
        {
            ...
            content: {
                ...
                body: [
                    ...
                    {
                        type: 'TextBlock',
                        text: `by ${commit.data.commit.author.name}${(author === null || author === void 0 ? void 0 : author.login) ? ` (@${author.login})` : ''} on ${timestamp}`,
                        wrap: true,
                        size: 'Small',
                        spacing: 'None',
                    },
